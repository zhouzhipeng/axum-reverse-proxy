...
//!
//! **Note:** The `native-tls` feature is a separate opt-in and is not included in the `full`
//! feature set. This ensures that rustls remains the default for security and consistency.
